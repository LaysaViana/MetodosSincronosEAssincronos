...
// No código abaixo, esta música foi implementada, porém cada verso leva um tempo 
// indefinido (aleatório) para ser "cantado" na tela. A consequência disso é que 
// raramente a música será cantada da forma correta.
//  Modifique os métodos de versos, utilizando callbacks, de forma que a música seja 
// reproduzida na **`sequência correta`**. o tipo do callback já está definido em 
// `callbackFn`
